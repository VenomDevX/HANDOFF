          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full h-10 bg-surface text-xs font-mono uppercase tracking-widest hover:bg-surface-hover disabled:opacity-50 flex items-center justify-center gap-2 transition-colors rounded-sm"
              >
