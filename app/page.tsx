...
import { ArrowRight, BarChart3, CheckCircle2, GitPullRequest, Layers, Lock, Shield, Terminal, Zap, Activity, Cpu, Loader2 } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const horizontalX = useTransform(sectionProgress, [0, 1], ["0%", "-66.666%"]);
        ...
        <div className="w-full px-6 md:px-12 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button 
              ...
              className="text-xs font-mono uppercase tracking-widest hover:text-foreground text-muted-foreground transition-colors disabled:opacity-50 flex items-center gap-2"
            >
            ...
            <Button 
              ...
              disabled={isNavigating}
              className="bg-foreground text-background hover:bg-foreground/90 rounded-none h-8 px-6 text-xs font-mono uppercase tracking-widest transition-all w-40"
            >
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-screen flex flex-col justify-center pt-28 pb-20 md:pt-24 md:pb-16 px-6 md:px-12 border-b border-border overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute top-1/2 right-0 -translate-y-1/2 w-[650px] h-[650px] rounded-full pointer-events-none z-0 blur-[130px] bg-accent"
          />

          {/* Abstract Geometry */}
          <div className="absolute top-0 right-0 -mr-32 -mt-32 w-[600px] h-[600px] md:w-[800px] md:h-[800px] border border-border/40 rounded-full opacity-20 pointer-events-none z-0" />
          <div className="absolute top-0 right-0 -mr-16 -mt-16 w-[500px] h-[500px] md:w-[600px] md:h-[600px] border border-border/40 rounded-full opacity-30 pointer-events-none z-0" />
          <motion.div
            aria-hidden
            animate={{ rotate: 360 }}
            transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
            className="absolute top-0 right-0 -mr-24 -mt-24 w-[560px] h-[560px] md:w-[700px] md:h-[700px] border border-accent/30 border-dashed rounded-full opacity-40 pointer-events-none z-0"
          />
            ...
            >
              ...
              <div className="mt-8 border-t border-border pt-8 relative">
                ...
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed font-light mb-8 max-w-xl">
                  DevPilot Enterprise brings projects, sprints, teams, releases, documentation, compliance, and AI intelligence into one hyper-structured, high-performance workspace.
                </p>
        ...
        {/* Infinite Marquee */}
        <section className="section-inverse py-6 border-b border-border bg-foreground text-background overflow-hidden flex items-center whitespace-nowrap">
          <motion.div 
            animate={{ x: [0, -1035] }} 
        ...
        <section className="px-6 md:px-12 py-32 bg-surface border-b border-border relative perspective-[2000px]">
          <div className="container mx-auto max-w-7xl">
            <motion.div 
              ...
              className="border border-border bg-background shadow-2xl relative transition-transform"
            >
               {/* UI Frame Top */}
               <div className="w-full h-10 bg-surface-elevated border-b border-border flex items-center justify-between px-4">
               ...
               <div className="flex h-[600px] lg:h-[700px]">
                  ...
                  {/* Fake Main Area */}
                  <div className="flex-1 bg-surface p-8 overflow-hidden relative">
        ...
        <section ref={targetRef} className="relative bg-background border-b border-border h-[400vh]">
          <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
            <motion.div
              style={{ x: horizontalX }}
              className="flex h-full w-[300vw] items-center relative z-10"
            >
              {/* Panel 1: Data Integrity */}
              <div className="w-[100vw] h-full flex items-center justify-between px-6 md:px-24 border-r border-border/30 relative overflow-hidden">
                <div className="max-w-2xl relative z-10">
                  <div className="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-8">Phase_01 // Architecture</div>
                  <h2 className="text-6xl md:text-8xl font-bold tracking-tighter uppercase leading-[0.9] mb-8">
                    Data<br/>Integrity.
                  </h2>
                  <p className="text-muted-foreground text-lg leading-relaxed max-w-lg mb-12 font-light">
                    Every operation is mathematically verified. We enforce cryptographic guarantees across all state mutations, ensuring your system of record remains absolutely pristine.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full">
                     <div>
                       <div className="h-px w-full bg-border mb-6" />
                       <div className="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-2">Cryptographic</div>
                       <div className="text-xl font-bold text-foreground">AES-256</div>
                     </div>
                     <div>
                       <div className="h-px w-full bg-border mb-6" />
                       <div className="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-2">Redundancy</div>
                       <div className="text-xl font-bold text-foreground">Multi-AZ</div>
                     </div>
                  </div>
                </div>

                {/* Panel 1 Graphic */}
                <div className="hidden md:flex flex-col items-center justify-center w-[500px] h-[500px] relative">
                   <div className="absolute inset-0 border border-border rounded-full opacity-20" />
                   <motion.div
                     animate={{ rotate: 360 }}
                     transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
                     className="absolute inset-4 border border-border rounded-full opacity-40 border-dashed"
                   />
                   <motion.div
                     animate={{ rotate: -360 }}
                     transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                     className="absolute inset-12 border border-foreground rounded-full opacity-60 border-dotted border-4"
                   />
                   ...
                   <div className="relative z-10 bg-background border border-foreground p-8 flex flex-col items-center gap-4 overflow-hidden group">
                     <div className="absolute inset-0 bg-foreground/5 translate-y-[100%] group-hover:translate-y-0 transition-transform duration-500" />
                     <Shield className="w-10 h-10 text-foreground relative z-10" />
                     <div className="font-mono text-xs uppercase tracking-widest relative z-10">Vault Secured</div>
                     <div className="flex gap-2 relative z-10 items-end h-8">
                       {[...Array(5)].map((_, i) => (
                         <motion.div
                           key={i}
                           animate={{ height: ["12px", "32px", "12px"] }}
                           transition={{ duration: 1.5, repeat: Infinity, delay: i * 0.1 }}
                           className={`w-2 ${i === 4 ? 'bg-border' : 'bg-foreground'}`}
                         />
                       ))}
                     </div>
                   </div>
              ...
              <div className="w-[100vw] h-full flex items-center justify-between px-6 md:px-24 border-r border-border/30 bg-surface relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,var(--foreground)_0%,transparent_70%)] opacity-5 pointer-events-none" />

                <div className="max-w-2xl relative z-10">
                  <div className="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-8">Phase_02 // Distribution</div>
                  <h2 className="text-6xl md:text-8xl font-bold tracking-tighter uppercase leading-[0.9] mb-8">
                    Global<br/>Scale.
                  </h2>
                  <p className="text-muted-foreground text-lg leading-relaxed max-w-lg mb-12 font-light">
                    Your infrastructure distributed automatically across 24 edge regions. No configuration required. Requests are routed to the nearest core instantly.
                  </p>
                  <div className="w-full max-w-xl bg-background border border-border p-8 relative overflow-hidden group">
                    <div className="absolute inset-0 bg-foreground/5 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-700 ease-out" />
                    <div className="flex justify-between items-end relative z-10">
                      <div>
                        <div className="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-2">Active Regions</div>
                        <div className="text-5xl font-bold tracking-tighter">24<span className="text-accent text-2xl animate-pulse">.</span></div>
                      </div>
                      <div className="w-16 h-16 border border-foreground rounded-full flex items-center justify-center border-dashed animate-spin-slow">
                ...
                {/* Panel 2 Graphic */}
                <div className="hidden md:flex items-center justify-center w-[500px] h-[500px] relative z-10">
                  <div className="absolute inset-0 border border-border rounded-full opacity-20" />
                  <div className="absolute inset-16 border border-border rounded-full opacity-40 border-dashed" />

                  {/* Central Node */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                    <div className="relative flex items-center justify-center">
                      <div className="absolute w-24 h-24 bg-foreground/10 rounded-full animate-ping" />
                      <div className="w-16 h-16 bg-background border-2 border-foreground rounded-full flex items-center justify-center relative z-10 shadow-[0_0_30px_rgba(255,255,255,0.1)]">
                        <div className="w-4 h-4 bg-foreground rounded-full animate-pulse" />
                      </div>
                      <div className="absolute top-full mt-4 bg-foreground text-background px-3 py-1 font-mono text-xs uppercase tracking-widest whitespace-nowrap">
                        Primary Core
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Satellite Nodes */}
                  {[
                    { label: 'US-EAST', angle: 0 },
                    { label: 'EU-WEST', angle: Math.PI / 2 },
                    { label: 'AP-SOUTH', angle: Math.PI },
                    { label: 'SA-EAST', angle: (3 * Math.PI) / 2 }
                  ].map((node, i) => {
                    const radius = 180;
                    ...
                    return (
                      ...
                      >
                         <div className="relative group">
                           <div className="w-12 h-12 bg-surface border border-border rounded-full flex items-center justify-center group-hover:border-foreground transition-colors relative z-10">
                             <div className="w-2 h-2 bg-foreground/50 rounded-full group-hover:bg-foreground transition-colors" />
                           </div>

                           {/* Node Label */}
                           <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 font-mono text-[10px] text-muted-foreground uppercase whitespace-nowrap group-hover:text-foreground transition-colors">
                             {node.label}
                           </div>
                         </div>
                         ...
                         <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: 'visible' }}>
                            ...
                            <motion.circle
                              ...
                              transition={{ duration: 1.5 + (i * 0.4) % 1.5, repeat: Infinity, ease: "linear", delay: (i * 0.2) % 1 }}
                            />
                         </svg>
                      </div>
                    );
              ...
              <div className="w-[100vw] h-full flex items-center justify-between px-6 md:px-24 relative overflow-hidden">
                <div className="max-w-2xl relative z-10">
                  <div className="font-mono text-xs uppercase tracking-widest text-muted-foreground mb-8">Phase_03 // Velocity</div>
                  <h2 className="text-6xl md:text-8xl font-bold tracking-tighter uppercase leading-[0.9] mb-8">
                    Real-Time<br/>Sync.
                  </h2>
                  <p className="text-muted-foreground text-lg leading-relaxed max-w-lg mb-12 font-light">
                    Sub-millisecond state propagation. When a variable changes in Tokyo, it updates in New York before the screen can even refresh. Built for velocity.
                  </p>
                  <div className="flex gap-8 items-center border border-border p-6 bg-surface-hover w-fit">
                    <div className="flex flex-col gap-2">
                       <div className="w-32 h-1 bg-foreground/20 overflow-hidden relative">
                         <motion.div
                           animate={{ x: ["-100%", "0%", "-100%"] }}
                           transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                           className="absolute inset-y-0 left-0 bg-foreground w-full"
                         />
                       </div>
                       <div className="w-32 h-1 bg-foreground/20 overflow-hidden relative">
                         <motion.div
                    ...
                    <div>
                      <div className="text-3xl font-bold tracking-tighter">{'<'}12ms</div>
                      <div className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">P99 Latency</div>
                    </div>
                  </div>
                </div>

                {/* Panel 3 Graphic */}
                <div className="hidden md:flex flex-col gap-8 w-[500px]">
                  {[
                    { id: 'CH_01', status: 'SYNCING', val: 75 },
                    { id: 'CH_02', status: 'IDLE', val: 30 },
                    { id: 'CH_03', status: 'SYNCING', val: 90 },
                    { id: 'CH_04', status: 'ACTIVE', val: 60 },
                    { id: 'CH_05', status: 'SYNCING', val: 45 },
                  ].map((ch, i) => (
                     <div key={i} className="flex items-center gap-6 group">
                       <div className="font-mono text-xs uppercase text-muted-foreground w-12 group-hover:text-foreground transition-colors">
                         {ch.id}
                       </div>

                       <div className="flex-1 h-8 bg-surface border border-border flex items-center p-1">
                         <motion.div
                           animate={{
                             width: [`${ch.val - 10}%`, `${ch.val + 10}%`, `${ch.val - 10}%`]
                           }}
                           transition={{
                             duration: (i * 0.7) % 2 + 2,
                             repeat: Infinity,
                           ...
                           className={`h-full ${ch.status === 'SYNCING' ? 'bg-foreground' : 'bg-border'} relative overflow-hidden`}
                         >
                           {ch.status === 'SYNCING' && (
                             <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.1)_25%,rgba(255,255,255,0.1)_50%,transparent_50%,transparent_75%,rgba(255,255,255,0.1)_75%,rgba(255,255,255,0.1)_100%)] bg-[size:10px_10px]" />
                           )}
                         </motion.div>
                       </div>

                       <div className="w-20 flex justify-between items-center">
                         <div className={`font-mono text-[10px] ${ch.status === 'SYNCING' ? 'text-foreground font-bold' : 'text-muted-foreground'}`}>
                           {ch.status}
                         </div>
                         <div className={`w-2 h-2 rounded-full ${ch.status === 'SYNCING' ? 'bg-foreground animate-pulse' : 'bg-border'}`} />
                       </div>
                     </div>
                  ))}
                </div>
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10">
             ...
             <div className="mt-16 md:mt-20">
                ...
                <div className="relative h-[clamp(330px,44vw,620px)] w-full flex items-center justify-center overflow-visible bg-transparent">
                   ...
                   <svg viewBox="0 0 900 450" preserveAspectRatio="xMidYMid meet" className="relative z-10 w-[108%] h-[108%] max-w-none overflow-visible text-background" fill="none">
                     {(() => {
                       ...
                       const map = (
                         <g key="worldmap">
                           ...
                           <rect x="0" y="0" width="900" height="450" fill="url(#landDots)" clipPath="url(#landClip)" />
                         </g>
                       );
        ...
        <section className="section-inverse py-40 bg-foreground text-background overflow-hidden relative">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-background/20 rounded-full opacity-30 pointer-events-none flex items-center justify-center">
            <div className="w-[600px] h-[600px] border border-background/40 rounded-full" />
            <div className="absolute w-[400px] h-[400px] border border-background/60 rounded-full" />
            <div className="absolute w-[200px] h-[200px] border border-background border-dashed rounded-full animate-spin-slow" />
          </div>
        ...
        <div className="section-inverse py-8 bg-foreground text-background overflow-hidden border-t border-border/30">
          <motion.div 
            animate={{ x: ["0%", "-50%"] }} 
