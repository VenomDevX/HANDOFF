    ...
    <div className="max-w-2xl mx-auto space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div key={c.label} className="border border-border rounded p-4 space-y-1">
      ...
      {submitted ? (
        <div className="border border-border rounded p-8 flex flex-col items-center gap-4 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Input id="name" name="name" required placeholder="Your name" className="rounded font-mono text-xs" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="email" className="font-mono text-[10px] uppercase tracking-widest">Email</Label>
              <Input id="email" name="email" type="email" required placeholder="you@company.com" className="rounded font-mono text-xs" />
            </div>
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="subject" className="font-mono text-[10px] uppercase tracking-widest">Subject</Label>
            <Input id="subject" name="subject" required placeholder="How can we help?" className="rounded font-mono text-xs" />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="message" className="font-mono text-[10px] uppercase tracking-widest">Message</Label>
            <Textarea id="message" name="message" required rows={5} placeholder="Describe your question or issue..." className="rounded font-mono text-xs resize-none" />
          </div>
          <Button type="submit" disabled={loading} className="rounded font-mono text-xs uppercase tracking-widest bg-foreground text-background hover:bg-foreground/90 px-8">
